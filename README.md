# Awesome Free Online AI Models & APIs

Updated: June 2026

Mostly focused on good models for Hermes Agent, but other coding and automation AI enthusisits can find gems here.
...
**Caveat:** Free models generally need more
...
### Practical caveat: free quotas can disappear quickly
 ...
 Treat free tiers as useful for testing, auxiliary tasks, light research agents, compaction, scheduled jobs, and experimentation — not as guaranteed daily-driver capacity since their tokens / access will likely run out fast.

## Contributing

Use whichever path is easiest:

1. Open an issue with the correction or new provider/model.
2. Click “Edit this file” on GitHub and submit a pull request.
3. Fork the repo, edit locally, and open a pull request.

## What good updates include

For model/API entries, please include:

- provider or model name;
- official website or docs link;
- whether a free tier exists;
- known quota/rate limits;
- whether it is OpenAI-compatible;
- whether you tested it with Hermes Agent;
- date last verified.

*No referral spam, affiliate links, or untested claims.*
